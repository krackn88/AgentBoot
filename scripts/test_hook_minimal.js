...
k = k.replace(
  ...
  'function r(G,a,I,p){"use strict";var X=GI[G];if(G===135){window.__dec.n++;var fn=M(a,I,p,X.L,X.V,X.H,X.J,X.g);window.__dec.fnType=typeof fn;return fn;}return M(a,I,p,X.L,X.V,X.H,X.J,X.g);}',
);
...
const dom = new JSDOM("<!DOCTYPE html><html><body></body></html>", {
  ...
  beforeParse(w) {
    w.global = { nativeAgent: { ios: {}, invoke: function () { return null; } }, ck: init.ck };
...
console.log(JSON.stringify({ n: window.__dec.n, fnType: window.__dec.fnType }));
