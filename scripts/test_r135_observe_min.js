...
k = k.replace(
  ...
  'function r(G,a,I,p){"use strict";var X=GI[G];if(G===135){var fn=M(a,I,p,X.L,X.V,X.H,X.J,X.g);window.__obs.push({a:a,I:I,t:typeof fn});return fn;}return M(a,I,p,X.L,X.V,X.H,X.J,X.g);}',
);
...
console.log(JSON.stringify(window.__obs));
